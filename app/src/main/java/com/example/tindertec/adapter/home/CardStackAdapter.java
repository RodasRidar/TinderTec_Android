package com.example.tindertec.adapter.home;
...
public class CardStackAdapter extends RecyclerView.Adapter<CardStackAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            localidad = itemView.findViewById(R.id.item_city);
        ...
        public void setData(ItemModel itemModel) {
            Picasso.get()
                    ...
                    .centerCrop()
                    .into(image);
            nombre.setText(itemModel.getNombre());
            edad.setText(itemModel.getEdad());
            localidad.setText(itemModel.getLocalidad());
